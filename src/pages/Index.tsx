...
const Index = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-12 bg-[#1e2340]">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {/* Карточка 1 — Спецпредложение */}
            <Card className="p-6 bg-card/80 border-[#F6A327]/30 flex flex-col gap-4">
              <div className="inline-flex items-center gap-2 bg-[#F6A327] text-[#273369] font-bold text-xs uppercase tracking-widest rounded px-3 py-1 w-fit">
                <Icon name="Star" size={14} />
                Спецпредложение
              </div>
              <div>
                <p className="text-muted-foreground text-sm mb-1">Вибропогружатель электрический крановый</p>
                <h3 className="text-xl md:text-2xl font-bold text-foreground">Yongan DZJ-90</h3>
              </div>
              <div className="mt-auto">
                <a href="https://kgs-ural.ru/catalog/vibropogruzhateli-kranovie/seriya-dzj/yongan-dzj-90/" target="_blank" rel="noopener noreferrer">
                  <Button className="bg-[#F6A327] hover:bg-[#F6A327]/90 text-[#273369] font-semibold">
            ...
            <Card className="p-6 bg-card/80 border-border/30 flex flex-col gap-4">
              <div className="inline-flex items-center gap-2 bg-[#273369] text-[#F6A327] font-bold text-xs uppercase tracking-widest rounded px-3 py-1 w-fit border border-[#F6A327]/30">
                <Icon name="Truck" size={14} />
                Б/у техника
              </div>
              <div>
                <h3 className="text-xl md:text-2xl font-bold text-foreground mb-1">Б/у техника от партнёров</h3>
                <p className="text-muted-foreground text-sm">Большой выбор б/у оборудования с актуальными ценами</p>
              </div>
              <div className="mt-auto">
                <Button
                  onClick={() => document.getElementById('used-equipment')?.scrollIntoView({ behavior: 'smooth' })}
      ...
      <section id="used-equipment" className="py-12 bg-[#181c30]">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center">Перечень свободной техники для реализации</h2>
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse min-w-[700px]">
              <thead>
                <tr className="bg-[#273369] text-[#F6A327]">
                  <th className="border border-border/20 px-3 py-2 text-left font-semibold">№</th>
                  <th className="border border-border/20 px-3 py-2 text-left font-semibold">Наименование</th>
                  <th className="border border-border/20 px-3 py-2 text-left font-semibold">VIN номер</th>
                  <th className="border border-border/20 px-3 py-2 text-left font-semibold">Местонахождение</th>
                  <th className="border border-border/20 px-3 py-2 text-center font-semibold">Год</th>
                  <th className="border border-border/20 px-3 py-2 text-left font-semibold">Наработка / пробег</th>
                  <th className="border border-border/20 px-3 py-2 text-right font-semibold">Стоимость (руб)</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  if ('group' in row) {
                    return (
                      <tr key={i} className="bg-[#273369]/60">
                        <td colSpan={7} className="border border-border/20 px-3 py-2 font-bold text-[#F6A327] text-xs uppercase tracking-wide">
                          {row.group}
                        </td>
                      </tr>
                    );
                  ...
                  return (
                    <tr key={i} className={i % 2 === 0 ? 'bg-card/30' : 'bg-card/10'}>
                      <td className="border border-border/20 px-3 py-2 text-muted-foreground text-center">{row.n}</td>
                      <td className="border border-border/20 px-3 py-2">{row.name}</td>
                      <td className="border border-border/20 px-3 py-2 text-muted-foreground text-xs font-mono">{row.vin}</td>
                      <td className="border border-border/20 px-3 py-2 text-muted-foreground text-xs">{row.loc}</td>
                      <td className="border border-border/20 px-3 py-2 text-center text-muted-foreground">{row.year || ''}</td>
                      <td className="border border-border/20 px-3 py-2 text-muted-foreground text-xs">{row.hours}</td>
                      <td className={`border border-border/20 px-3 py-2 text-right font-semibold ${row.price === 'по запросу' ? 'text-muted-foreground text-xs italic' : 'text-[#F6A327]'}`}>
          ...
          <div className="text-center mt-8">
            <Button onClick={scrollToForm} className="bg-[#F6A327] hover:bg-[#F6A327]/90 text-[#273369] font-semibold px-8">
