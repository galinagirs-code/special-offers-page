  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="sr-only" aria-hidden="true">
        <h1>Продажа б/у строительной техники по России — КГС КоперГруппСервис</h1>
        <h2>Перечень свободной спецтехники в наличии</h2>
        <p>Купить б/у краны, буровые установки, экскаваторы. Каталог спецтехники с пробегом и наработкой. Тяжёлая строительная техника: продажа из наличия.</p>
        <h2>Б/у спецтехника в наличии — ключевые категории</h2>
        <ul>
          <li>Купить гусеничный кран б/у — Sany SCC2000, SCC1800A, SCC1350A-5; Zoomlion ZCC1500</li>
          <li>Автокраны с наработкой в продаже — Zoomlion ZRT600, Галичанин г/п 25 тн Камаз 6x6</li>
          <li>Буровые установки б/у цена — Zoomlion ZR360L, ZR255D, ZR255B; Sany SR235; Buma R1820 RCD</li>
          <li>Вибропогружатели и гидромолоты купить — Ozkanlar SVR, Yongan DZJ-90, Junttan HHK 9S, Starke HD62</li>
          <li>Экскаваторы Hyundai б/у — R330LC-9S, R300LC-9S, R260LC-9S, HX220S</li>
          <li>Техника Sany, Zoomlion, Shantui в наличии — бульдозеры SD-16, погрузчики, самосвалы</li>
          <li>Дробилки и грохоты б/у — McCloskey I54, NFLG NFS350</li>
          <li>Генераторные установки и мачты — Genmac ROYAL, ATLAS Copco, KEDASA KLD5000, FENIX</li>
        </ul>
        <h2>Продажа спецтехники по регионам</h2>
        <ul>
          <li>Спецтехника Владивосток — купить б/у технику в наличии</li>
          <li>Спецтехника Хабаровск — в наличии гусеничные краны и буровые</li>
          <li>Продажа техники Приморский край — техника с документами и VIN номером</li>
          <li>Строительная техника Дальний Восток — оперативная отгрузка</li>
          <li>Тяжёлая техника Екатеринбург — продажа со склада КоперГруппСервис</li>
        </ul>
        <h2>Вибропогружатель электрический крановый Yongan DZJ-90 купить в Екатеринбурге</h2>
        <p>Вибропогружатель электрический крановый Yongan DZJ-90 в наличии в Екатеринбурге. Полная комплектация: шкаф управления, зажим, ЗИП. Гарантия 12 месяцев. Доставка по России и СНГ. Мощность 90 кВт, центробежная сила 0-579 кН.</p>
        <p>Тяжёлая строительная техника для строительства и свайных работ. Спецтехника с документами и VIN номером. Продажа строительной техники с пробегом от ведущих мировых производителей.</p>
      </section>
